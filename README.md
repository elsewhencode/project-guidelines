...
* Sync with remote to get changes you’ve missed
    ...
    git pull
    ```
* Update your feature branch with latest changes from develop by interactive rebase ([Here is why](https://www.atlassian.com/git/tutorials/merging-vs-rebasing#the-golden-rule-of-rebasing)). Don't forget to [squash all your commits to a single commit](http://gitready.com/advanced/2009/02/10/squashing-commits-with-rebase.html). Nobody wants a lot of commits for a single feature in develop branch! 
    ```
